...
export default function () {
  ...
  return (
    <div className="container mx-auto p-10 mt-10 text-center">
      ...
      <a
        href="/cv.pdf"
        className="text-white bg-blue-700 inline-block hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center"
      >
        Open resume as PDF
        <svg
          aria-hidden="true"
