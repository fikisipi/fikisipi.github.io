    ...
    return (
      <div className="container mx-auto text-white px-10 py-10 mt-4">
        <div className="xtext-lg xfont-bold pb-5 pl-2">
          ...
          <div className="text-sm font-medium text-center text-gray-500 border-b border-gray-200 !text-zinc-400 !border-zinc-700">
            <ul className="flex flex-wrap -mb-px">
              <li className="mr-2">
                <a
                  href="#"
                  className="inline-block p-3 text-indigo-600 border-b-2 border-indigo-600 rounded-t-lg active !text-zinc-300 !border-zinc-300"
                  aria-current="page"
                >
                  Results
                </a>
